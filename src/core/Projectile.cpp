...
Rectangle Projectile::getCollisionBounds() const
{
    return {
...
void Projectile::draw() const
{
    ...
    DrawRectangleLines(collisionBounds.x, collisionBounds.y, collisionBounds.width, collisionBounds.height, GREEN);
}